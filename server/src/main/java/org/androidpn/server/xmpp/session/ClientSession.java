...
public class ClientSession extends Session {
	 ...
	 */
	public static ClientSession createSession(String serverName, Connection connection, XmlPullParser xpp)
